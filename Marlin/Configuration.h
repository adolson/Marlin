...
#define STRING_CONFIG_H_AUTHOR "(Dana Olson, stock ER-20)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Eryone ER-20"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 34, 0 ,-2.1 }
